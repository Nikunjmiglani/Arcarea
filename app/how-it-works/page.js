    ...
    points: [
      {
        ...
        desc: 'Once you are happy with what we have proposed, pay 10% of the final quote or Rs.25000 (whichever is higher) to book us.',
        badge: 'MILESTONE',
      },
      {
        heading: 'Finalise your home design',
        desc: 'It is time to deep dive into the nitty-gritties & pick your favorite materials, finishes, etc.',
      },
    ],
          ...
          {stepsList.map((step, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="relative w-28 h-28">
                <Image src={step.img} alt={step.title} layout="fill" className="rounded-full object-cover" />
              </div>
      ...
      <section className="bg-white py-16 px-4 sm:px-8 space-y-24 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="md:w-1/2 space-y-6">
            ...
            <div>
              <h4 className="text-lg font-semibold flex items-center gap-2">✅ Installation</h4>
              <p className="text-gray-600 mt-1">
